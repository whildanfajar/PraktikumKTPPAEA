 ...
 */
package praktikum.pae.ktp.project.ktp;
...
import praktikum.pae.ktp.project.ktp.exceptions.NonexistentEntityException;
import praktikum.pae.ktp.project.ktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("praktikum.pae.ktp_project.ktp_jar_0.0.1-SNAPSHOTPU");
